...
SHOW WARNINGS;
CREATE INDEX `fk_tbgenSolicitudServTipo_1` ON `mydb2`.`tbgenSolServ_TipoSol` (`fk_iID_SOLICITUD` ASC) ;

SHOW WARNINGS;
CREATE INDEX `fk_tbgenSolicitudServTipo_2` ON `mydb2`.`tbgenSolServ_TipoSol` (`fk_iID_TIPO_SOLICITUD` ASC) ;
...
SHOW WARNINGS;
CREATE INDEX `fk_tbgenCalidadServ_1` ON `mydb2`.`tbgenSolServ_CalServPreg` (`fk_iID_CAL_SOl_PREG` ASC) ;

SHOW WARNINGS;
CREATE INDEX `fk_tbgenCalidadServ_2` ON `mydb2`.`tbgenSolServ_CalServPreg` (`fk_iID_SOL` ASC) ;
