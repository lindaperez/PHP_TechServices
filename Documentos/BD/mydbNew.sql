...
CREATE  TABLE IF NOT EXISTS `mydb`.`tbdetDetalleUsuario` (
  `id` INT NOT NULL ,
  `iID_DETALLE` INT NOT NULL ,
  `vDETALLE` INT NOT NULL ,
  PRIMARY KEY (`id`) )
ENGINE = InnoDB;
...
CREATE  TABLE IF NOT EXISTS `mydb`.`tbgenSolicitudServicio` (
  ...
  `iTIPO_SOL` INT NOT NULL ,
  `iESPECIFICACION` INT NOT NULL ,
  `fk_iID_DETALLE_USUARIO` INT NOT NULL ,
  ...
  CONSTRAINT `fk_iID_USUA`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_iID_DETALLE_USUARIO`
    FOREIGN KEY (`fk_iID_DETALLE_USUARIO` )
    REFERENCES `mydb`.`tbdetDetalleUsuario` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
