...
SHOW WARNINGS;
CREATE UNIQUE INDEX `pk_icedula_UNIQUE` ON `mydb`.`tbdetUsuarioDatos` (`pk_icedula` ASC) ;
...
SHOW WARNINGS;
CREATE UNIQUE INDEX `fk_iCI_UNIQUE` ON `mydb`.`tblogConexion` (`fk_iCI` ASC) ;
