...
CREATE  TABLE IF NOT EXISTS `mydb`.`tbgenSolicitudServicio` (
  ...
  CONSTRAINT `fk_tbgenSolicitudServicio_1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbgenEstatusSolicitud`
    FOREIGN KEY (`fk_iID_ESTATUS` )
...
SHOW WARNINGS;
CREATE INDEX `fk_iID_ESTATUS` ON `mydb`.`tbgenSolicitudServicio` (`fk_iID_ESTATUS` ASC) ;
...
-- -----------------------------------------------------
-- Table `mydb`.`PersonaPotencial`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`PersonaPotencial` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `mydb`.`PersonaPotencial` (
  `id` INT NOT NULL ,
...
SHOW WARNINGS;
CREATE INDEX ON `mydb`.`PersonaPotencial` () ;
...
-- -----------------------------------------------------
-- Table `mydb`.`PreguntaForm`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`PreguntaForm` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `mydb`.`PreguntaForm` (
  `id` INT NOT NULL ,
  `vdescripcion` VARCHAR(45) NULL ,
  PRIMARY KEY (`id`) )
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`formularioRelacion`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`formularioRelacion` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `mydb`.`formularioRelacion` (
  `id` INT NOT NULL ,
  `fk_iID_idForm` INT NOT NULL ,
  `fk_iID_idPreg` INT NOT NULL ,
  PRIMARY KEY (`id`) ,
  CONSTRAINT `FK_formularioRelacion`
    FOREIGN KEY (`fk_iID_idForm` )
    REFERENCES `mydb`.`formulario` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_formularioRelacion_1`
    FOREIGN KEY (`fk_iID_idPreg` )
    REFERENCES `mydb`.`PreguntaForm` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

SHOW WARNINGS;
CREATE INDEX `FK_formularioRelacion` ON `mydb`.`formularioRelacion` (`fk_iID_idForm` ASC) ;

SHOW WARNINGS;
CREATE INDEX `FK_formularioRelacion_1` ON `mydb`.`formularioRelacion` (`fk_iID_idPreg` ASC) ;

SHOW WARNINGS;
CREATE INDEX ON `mydb`.`formularioRelacion` () ;

SHOW WARNINGS;

-- -----------------------------------------------------
-- Table `mydb`.`RespuestaForm`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`RespuestaForm` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `mydb`.`RespuestaForm` (
  `id` INT NOT NULL ,
  `vdescripcion` VARCHAR(45) NULL ,
  PRIMARY KEY (`id`) )
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`PersonaRelForm`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`PersonaRelForm` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `mydb`.`PersonaRelForm` (
  `id` INT NOT NULL ,
  `id_persona` INT NOT NULL ,
  `id_formul` INT NOT NULL ,
  PRIMARY KEY (`id`) ,
  CONSTRAINT `FK_PersonaRelForm_1`
    FOREIGN KEY (`id_persona` )
    REFERENCES `mydb`.`PersonaPotencial` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_PersonaRelForm_2`
    FOREIGN KEY (`id_formul` )
    REFERENCES `mydb`.`formulario` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
SHOW WARNINGS;
CREATE INDEX `FK_PersonaRelForm_1` ON `mydb`.`PersonaRelForm` (`id_persona` ASC) ;

SHOW WARNINGS;
CREATE INDEX `fk_PersonaRelForm_2` ON `mydb`.`PersonaRelForm` (`id_formul` ASC) ;

SHOW WARNINGS;

-- -----------------------------------------------------
-- Table `mydb`.`PregRespRel`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`PregRespRel` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `mydb`.`PregRespRel` (
  `id` INT NOT NULL ,
  `id_preg` INT NOT NULL ,
  `id_resp` INT NOT NULL ,
  PRIMARY KEY (`id`) ,
  CONSTRAINT `FK_PregRespRel_1`
    FOREIGN KEY (`id_preg` )
    REFERENCES `mydb`.`PreguntaForm` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_PregRespRel_2`
    FOREIGN KEY (`id_resp` )
    REFERENCES `mydb`.`RespuestaForm` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

SHOW WARNINGS;
CREATE INDEX `FK_PregRespRel_1` ON `mydb`.`PregRespRel` (`id_preg` ASC) ;

SHOW WARNINGS;
CREATE INDEX `FK_PregRespRel_2` ON `mydb`.`PregRespRel` (`id_resp` ASC) ;
