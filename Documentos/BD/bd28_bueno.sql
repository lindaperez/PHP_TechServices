...
SHOW WARNINGS;
CREATE INDEX `fk_iID_SOLICITUD` ON `mydb`.`tbgenSolServ_TipoSol` (`fk_iID_SOLICITUD` ASC) ;

SHOW WARNINGS;
CREATE INDEX `fk_iID_TIPO_SOLICITUD` ON `mydb`.`tbgenSolServ_TipoSol` (`fk_iID_TIPO_SOLICITUD` ASC) ;
...
SHOW WARNINGS;
CREATE INDEX `fk_iID_TIPO_SOL` ON `mydb`.`tbgenTipoSol_EspSol` (`fk_iID_TIPO_SOL` ASC) ;

SHOW WARNINGS;
CREATE INDEX `fk_iID_ESP_SOL` ON `mydb`.`tbgenTipoSol_EspSol` (`fk_iID_ESP_SOL` ASC) ;
...
SHOW WARNINGS;
CREATE INDEX `fk_iID_CAL_SOL_PREG` ON `mydb`.`tbgenSolServ_CalServPreg` (`fk_iID_CAL_SOl_PREG` ASC) ;

SHOW WARNINGS;
CREATE INDEX `fk_iID_SOL` ON `mydb`.`tbgenSolServ_CalServPreg` (`fk_iID_SOL` ASC) ;
...
SHOW WARNINGS;
CREATE INDEX `fk_iID_ESP_SOL` ON `mydb`.`tbgenEspSol_Det` (`fk_iID_ESP_SOL` ASC) ;

SHOW WARNINGS;
CREATE INDEX `fk_iID_DETA` ON `mydb`.`tbgenEspSol_Det` (`fk_iID_DETA` ASC) ;
...
SHOW WARNINGS;
CREATE INDEX `fk_iID_SOL_TIPO` ON `mydb`.`tbdetSol_CamposUsu` (`fk_iID_SOL_TIPO` ASC) ;

SHOW WARNINGS;
CREATE INDEX `fk_iID_TIPO_ESP` ON `mydb`.`tbdetSol_CamposUsu` (`fk_iID_TIPO_ESP` ASC) ;

SHOW WARNINGS;
CREATE INDEX `fk_iID_ESP_DET` ON `mydb`.`tbdetSol_CamposUsu` (`fk_iID_ESP_DET` ASC) ;
...
SHOW WARNINGS;
CREATE INDEX `fk_iID_CalServPreg_CalSerResp` ON `mydb`.`tbdetCalidad_Campos` (`fk_iID_CalServPreg_CalSerResp` ASC) ;

SHOW WARNINGS;
CREATE INDEX `fk_iID_SolServ_CalServPreg` ON `mydb`.`tbdetCalidad_Campos` (`fk_iID_SolServ_CalServPreg` ASC) ;
