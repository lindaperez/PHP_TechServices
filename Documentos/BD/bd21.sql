...
CREATE  TABLE IF NOT EXISTS `mydb2`.`tbgenSolicitudServicio` (
  ...
  PRIMARY KEY (`id`) ,
  CONSTRAINT `fk_tbgenSolicitudServicio_Usu`
...
SHOW WARNINGS;
CREATE INDEX `fk_tbgenSolicitudServicio_Usu` ON `mydb2`.`tbgenSolicitudServicio` (`fk_iID_USU_DATOS` ASC) ;
...
SHOW WARNINGS;
CREATE INDEX `fk_tbdetSolicitudServTipo_1` ON `mydb2`.`tbgenSolServ_TipoSol` (`fk_iID_SOLICITUD` ASC) ;

SHOW WARNINGS;
CREATE INDEX `fk_tbdetSolicitudServTipo_2` ON `mydb2`.`tbgenSolServ_TipoSol` (`fk_iID_TIPO_SOLICITUD` ASC) ;
...
SHOW WARNINGS;
CREATE INDEX `fk_tbdetEspecSolTipo_1` ON `mydb2`.`tbgenTipoSol_EspSol` (`fk_iID_TIPO_SOL` ASC) ;

SHOW WARNINGS;
CREATE INDEX `fk_tbdetEspecSolTipo_2` ON `mydb2`.`tbgenTipoSol_EspSol` (`fk_iID_ESP_SOL` ASC) ;
...
SHOW WARNINGS;
CREATE INDEX `fk_tbdetCalidadServ_1` ON `mydb2`.`tbgenSolServ_CalServPreg` (`fk_iID_CAL_SOl_PREG` ASC) ;

SHOW WARNINGS;
CREATE INDEX `fk_tbdetCalidadServ_2` ON `mydb2`.`tbgenSolServ_CalServPreg` (`fk_iID_SOL` ASC) ;
...
SHOW WARNINGS;
CREATE INDEX `fk_tbdetCalSerRel_1` ON `mydb2`.`tbgenCalSerPreg_CalSerResp` (`fk_iID_CAL_SER_PREG` ASC) ;

SHOW WARNINGS;
CREATE INDEX `fk_tbdetCalSerRel_2` ON `mydb2`.`tbgenCalSerPreg_CalSerResp` (`fk_iID_CAL_SER_RESP` ASC) ;
...
SHOW WARNINGS;
CREATE INDEX `fk_tbdetDetalle_Rel_1` ON `mydb2`.`tbgenEspSol_Det` (`fk_iID_ESP_SOL` ASC) ;

SHOW WARNINGS;
CREATE INDEX `fk_tbdetDetalle_Rel_2` ON `mydb2`.`tbgenEspSol_Det` (`fk_iID_DETA` ASC) ;
...
SHOW WARNINGS;
CREATE INDEX `fk_tbgenSol_Campos_1` ON `mydb2`.`tbdetSol_CamposUsu` (`fk_iID_SOL_TIPO` ASC) ;

SHOW WARNINGS;
CREATE INDEX `fk_tbgenSol_Campos_2` ON `mydb2`.`tbdetSol_CamposUsu` (`fk_iID_TIPO_ESP` ASC) ;

SHOW WARNINGS;
CREATE INDEX `fk_tbgenSol_Campos_3` ON `mydb2`.`tbdetSol_CamposUsu` (`fk_iID_ESP_DET` ASC) ;
...
SHOW WARNINGS;
CREATE INDEX `fk_tbdetCalidadResp_1` ON `mydb2`.`tbdetCalidad_Campos` (`fk_iID_CalServPreg_CalSerResp` ASC) ;

SHOW WARNINGS;
CREATE INDEX `fk_tbdetCalidadResp_2` ON `mydb2`.`tbdetCalidad_Campos` (`fk_iID_SolServ_CalServPreg` ASC) ;
