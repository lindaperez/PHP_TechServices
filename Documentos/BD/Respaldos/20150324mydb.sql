...
--
-- Servidor: localhost
-- Tiempo de generación: 24-03-2015 a las 13:12:25
...
--
-- Volcado de datos para la tabla `tbdetAlmacenista`
--

INSERT INTO `tbdetAlmacenista` (`id`, `vAlias`, `fk_iID_USUA_DATOSALM`) VALUES
(1, 'Almacenista1', 16);
...
--
-- Estructura de tabla para la tabla `tbdetCoordinadorPMO`
--

CREATE TABLE IF NOT EXISTS `tbdetCoordinadorPMO` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `valias` varchar(45) NOT NULL,
  `tbdetLiderPMO_id` int(11) DEFAULT NULL,
  `tbdetUsuarioDatos_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_tbdetCoordinadorPMO_tbdetLiderPMO1` (`tbdetLiderPMO_id`),
  KEY `fk_tbdetCoordinadorPMO_tbdetUsuarioDatos1` (`tbdetUsuarioDatos_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2 ;

--
-- Volcado de datos para la tabla `tbdetCoordinadorPMO`
--

INSERT INTO `tbdetCoordinadorPMO` (`id`, `valias`, `tbdetLiderPMO_id`, `tbdetUsuarioDatos_id`) VALUES
(1, 'Coordinador1', NULL, 17);
...
--
-- Volcado de datos para la tabla `tbdetCotizacion`
--

INSERT INTO `tbdetCotizacion` (`id`, `codCotizacion`, `tbdetCotizacioncol`, `fk_iID_EstatusInstalacion`) VALUES
(1, '13106', 1, 1),
(2, '12001', 3, 1),
(3, '13445', 5, 1);
...
--
-- Volcado de datos para la tabla `tbdetEstatusInstalacion`
--

INSERT INTO `tbdetEstatusInstalacion` (`id`, `vdescripcion`) VALUES
(1, 'Por Entregar'),
(2, 'Entregado Parcial'),
(3, 'Preparado'),
(4, 'Entrega Total');
...
--
-- Volcado de datos para la tabla `tbdetEstatusProyecto`
--

INSERT INTO `tbdetEstatusProyecto` (`id`, `vdescripcion`) VALUES
(1, 'Por Asignar  al Técnico'),
(3, 'Asignado'),
(4, 'Pedido Si'),
(5, 'Pedido No'),
(6, 'Entregado al Técnico'),
(7, 'Entregado');
...
CREATE TABLE IF NOT EXISTS `tbdetLiderPMO` (
  ...
  `tbdetUsuarioDatos_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_tbdetLiderPMO_tbdetUsuarioDatos1` (`tbdetUsuarioDatos_id`)
...
CREATE TABLE IF NOT EXISTS `tbdetProyecto` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `iCodProyecto` varchar(8) NOT NULL,
...
--
-- Volcado de datos para la tabla `tbdetProyecto`
--

INSERT INTO `tbdetProyecto` (`id`, `iCodProyecto`, `fk_iCodCotizacion`, `icantidad`, `fk_tbdetEstatusProyecto_id`) VALUES
(1, 'S-11135', 1, 4, 5),
(2, 'S-11139', 1, 12, 6),
(3, 'S-36100', 1, 1, 3),
(4, 'S-37113', 2, 16, 7),
...
--
-- Volcado de datos para la tabla `tbdetTecnico`
--

INSERT INTO `tbdetTecnico` (`id`, `vAlias`, `fk_iID_USUA_DATOSTECN`) VALUES
(1, 'Tecnico1', 14),
(2, 'Tecnico2', 15);
...
(14, 5432145, 'V-', 'Usuario Tecnico', 'Apellido Tecnico', 'rosmery.p.p@gmail.com', '4129511668', '4129511668', 'Tecnico', 'Techtrol', 'Tectrol', 'Uro1eOB7do+VKC5An+vK2ufaG5L6Wu0EqYVjixTRJYVaKfpHMqEuPpjC7s85bF2hA+rvbWybjYkYRWVPUh+6oA==', '2015-03-17 15:03:01'),
(15, 18915765, 'V-', 'TecnicoII', 'Apellido Tecnico', 'rosmery.p.p@gmail.com', '4129511668', '02122421510', 'Tecnico', 'Techtrol', 'Tectrol', '2Abhr5Jo+KviTGccNClFX8G9QWOTzY2kRkS3Dz0GOUHLSHXOTolnG3t6FtmY0gdTuXd+FPTGXO3E+a1TxTWNRA==', '2015-03-18 11:52:39'),
(16, 12833714, 'V-', 'Almacenista', 'Apellido Almacenista', 'rosmery.p.p@gmail.com', '4129511668', '02122421510', 'Almacenista', 'Techtrol', 'Tectrol', 'GIv41A4AlrLOMrIM0DqdZ50A7bndu7Eghos+Wt1+nF46tvV+iocs2Z0HKgLaSECcDCqsN5uqIL4xmQS1bhgpRg==', '2015-03-19 13:16:24'),
(17, 11555444, 'V-', 'Coordinador', 'Apellido Coordi', 'rosmery.p.p@gmail.com', '4129511668', '02122421510', 'coordinador', 'Techtrol', 'Sucursa', 'GuMYLQOJwynbS7RCkvIZeV+yx1Z2RgtmYjDbGt73WcMO9w7Jrhv9EcebxqZ8s67xGHNTjdf6Cu6kJ71haHwFZA==', '2015-03-23 09:37:33');
...
CREATE TABLE IF NOT EXISTS `tbrelTecnicoProyecto` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `dfecha` datetime NOT NULL,
  `vdescripcionCambioEst` varchar(200) NOT NULL,
...
--
-- Volcado de datos para la tabla `tbrelTecnicoProyecto`
--

INSERT INTO `tbrelTecnicoProyecto` (`id`, `dfecha`, `vdescripcionCambioEst`, `fk_iID_tbdetTecnico`, `fk_iID_tbdetPRoyecto`) VALUES
(15, '2015-03-18 12:01:20', 'Mensjae 10', 1, 1),
(16, '2015-03-18 12:01:20', 'Mensjae 10', 1, 2),
(17, '2015-03-18 12:01:20', 'Mensjae 10', 1, 3),
(18, '2015-03-18 12:01:20', 'Mensjae 10', 1, 4),
(19, '2015-03-19 15:24:41', 'Cualquier cosa', 2, 4),
(20, '2015-03-23 12:40:46', 'Mensjae', NULL, 5),
(21, '2015-03-23 12:40:46', 'Mensjae', NULL, 6);
...
--
-- Filtros para la tabla `tbdetCoordinadorPMO`
--
ALTER TABLE `tbdetCoordinadorPMO`
  ADD CONSTRAINT `fk_tbdetCoordinadorPMO_tbdetLiderPMO1` FOREIGN KEY (`tbdetLiderPMO_id`) REFERENCES `tbdetLiderPMO` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_tbdetCoordinadorPMO_tbdetUsuarioDatos1` FOREIGN KEY (`tbdetUsuarioDatos_id`) REFERENCES `tbdetUsuarioDatos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
-- Filtros para la tabla `tbdetLiderPMO`
--
ALTER TABLE `tbdetLiderPMO`
  ADD CONSTRAINT `fk_tbdetLiderPMO_tbdetUsuarioDatos1` FOREIGN KEY (`tbdetUsuarioDatos_id`) REFERENCES `tbdetUsuarioDatos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
